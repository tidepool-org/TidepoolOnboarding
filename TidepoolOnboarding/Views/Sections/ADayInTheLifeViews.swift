...
fileprivate struct ADayInTheLifeView1: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView2()) {
            PageHeader(title: LocalizedString("A Day in the Life with Tidepool Loop", comment: "Onboarding, A Day In The Life section, view 1, title"))
...
fileprivate struct ADayInTheLifeView3: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView4()) {
            PageHeader(title: LocalizedString("Using Pre-Meal Preset", comment: "Onboarding, A Day In The Life section, view 3, title"))
...
fileprivate struct ADayInTheLifeView4: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView5()) {
            PageHeader(title: LocalizedString("Entering Carbs", comment: "Onboarding, A Day In The Life section, view 4, title"))
...
fileprivate struct ADayInTheLifeView5: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView6()) {
            PageHeader(title: LocalizedString("Time to Bolus", comment: "Onboarding, A Day In The Life section, view 5, title"))
...
fileprivate struct ADayInTheLifeView6: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView7()) {
            PageHeader(title: LocalizedString("Let’s Eat", comment: "Onboarding, A Day In The Life section, view 6, title"))
...
fileprivate struct ADayInTheLifeView7: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView8()) {
            PageHeader(title: LocalizedString("Sleeping with Tidepool Loop", comment: "Onboarding, A Day In The Life section, view 7, title"))
...
fileprivate struct ADayInTheLifeView8: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView9()) {
            PageHeader(title: LocalizedString("Goodnight, App", comment: "Onboarding, A Day In The Life section, view 8, title"))
...
fileprivate struct ADayInTheLifeView9: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView10()) {
            PageHeader(title: LocalizedString("While Sleeping", comment: "Onboarding, A Day In The Life section, view 9, title"))
...
fileprivate struct ADayInTheLifeView10: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView11()) {
            PageHeader(title: LocalizedString("Nighttime Checks", comment: "Onboarding, A Day In The Life section, view 10, title"))
...
fileprivate struct ADayInTheLifeView11: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView12()) {
            PageHeader(title: LocalizedString("Rise and Shine", comment: "Onboarding, A Day In The Life section, view 11, title"))
...
fileprivate struct ADayInTheLifeView14: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView15()) {
            ...
            Paragraph(LocalizedString("You go ahead open Temporary Presets from either your iPhone or Apple Watch and select “Workout Preset” to tell Tidepool Loop to adjust your glucose target.", comment: "Onboarding, A Day In The Life section, view 14, paragraph 2"))
...
fileprivate struct ADayInTheLifeView15: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView16()) {
            PageHeader(title: LocalizedString("Ready to Roll", comment: "Onboarding, A Day In The Life section, view 15, title"))
...
fileprivate struct ADayInTheLifeView16: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView17()) {
            PageHeader(title: LocalizedString("Running Smoothly", comment: "Onboarding, A Day In The Life section, view 16, title"))
...
fileprivate struct ADayInTheLifeView17: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView18()) {
            PageHeader(title: LocalizedString("Highs and Lows", comment: "Onboarding, A Day In The Life section, view 17, title"))
...
fileprivate struct ADayInTheLifeView19: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView20()) {
            PageHeader(title: LocalizedString("2. Is Automation On?", comment: "Onboarding, A Day In The Life section, view 19, title"))
...
fileprivate struct ADayInTheLifeView21: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView22()) {
            PageHeader(title: LocalizedString("4. How Many Active Carbs Are Working to Raise Your Glucose?", comment: "Onboarding, A Day In The Life section, view 21, title"))
...
fileprivate struct ADayInTheLifeView22: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView23()) {
            PageHeader(title: LocalizedString("5. Is Your CGM Functioning Properly?", comment: "Onboarding, A Day In The Life section, view 22, title"))
...
fileprivate struct ADayInTheLifeView24: View {
    var body: some View {
        OnboardingSectionPageView(section: .aDayInTheLife, destination: ADayInTheLifeView25()) {
            PageHeader(title: LocalizedString("7. Do You Know Something Tidepool Loop Doesn’t?", comment: "Onboarding, A Day In The Life section, view 24, title"))
